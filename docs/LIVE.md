...
- **People throughout the day:** between events, follow a resident who is actually outdoors. Cast a neighbor for each three-minute chapter, prefer walkers over seated spectators, and switch away when the resident goes indoors. Keep the name label and foot highlight visible.

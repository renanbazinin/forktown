...
- **One minute of neighborhood scenery:** 05:00–06:00 town time, exactly 60 real seconds per 24-minute cycle. Frame Miso's current neighborhood with him outside, keeping activity visible even in this wider view. Reloading does not restart this window. If nobody is outdoors during the day and no event or match is live, show a quiet home while Miso sleeps.

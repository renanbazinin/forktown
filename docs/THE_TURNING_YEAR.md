...
The season light is one `fillRect`, drawn only in autumn and winter. Across the year, at several times of day, a whole opening-view frame stays between 30,400 and 31,750 calls, still about 31,000 and well inside the 40,000 budget of `tests/render-smoke.test.ts`. On the same day and minute, a frame differs from the town before the turning year by −752 to +214 calls. Spring and winter frames are often lighter than before, because the young farm and the snowy meadows draw less.
